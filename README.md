...
- `legacy-holdings-v1`은 기존 여섯 렌즈를 보존하고, `guru-market-nasdaq-v3`는 보유비중 페널티 없이 기업점수만 계산합니다. v3는 10-K 안의 분기 누적값을 연간 성장률로 오인하지 않도록 300일 이상 흐름값만 사용합니다.
- 후보군은 공식 Nasdaq-100 구성종목으로 고정하며, 보유종목을 제외한 Top 10을 종목당 10% 동일가중 연구 바스켓으로 시점보존합니다.
- 각 후보 상세에는 Toss 수정주가 기준 최근 260거래일 추세와 1·3·6·12개월 후행 수익률, 점수 기준일 이후 모의 성과를 분리해 표시합니다.
